...
**Rule of Thumb:** If it's a procedure, make it a skill. If it's a role, make it an agent.
...
Edit `docs/scripts/stitch-brain.py`:
...
- [ ] Recipe added to `stitch-brain.py`
- [ ] Agent generated in `.copilot/agents/` or `.github/agents/`
- [ ] Agent frontmatter is Copilot CLI compatible
